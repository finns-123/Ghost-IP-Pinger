@echo off
color 4
title Ghost IP Pinger
echo =====================================================
echo WELCOME TO GHOST'S IP PINGER. 
echo =====================================================
echo                ...
echo              ;::::;
echo           ;::::; :;
...
echo    ::::::`:::::;'  /  /   `#
echo.
echo pssssst type "ghost" to search your targets ip info!
echo.
echo.
:hub
set /p var=Enter IP~
if %var%==ghost goto iplook
...
:d
echo ==================================
echo Join https://discord.gg/SPB76WY8cY
echo ==================================
:x
